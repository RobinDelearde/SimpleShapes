...
of the numeric keypad or keys N-H-K-U, and ? for ambiguous cases) and the
difficulty level (1-2-3, or 4 for ambiguous cases), in two columns of a csv file.
...
for f in files_list:
    ...
    while not difficulty_ok:
        difficulty = input('difficulty (1: easy, 2: medium, 3: hard, 4: ambigous) : ')
        difficulty_ok = any(difficulty==s for s in ['1', '2', '3', '4'])
    annotation_file.write(img_path+' '+annotation+' '+difficulty+'\n')
